...
{	
	...
	$sql = "INSERT INTO R6_ (user_id, username, user_stats, last_update) VALUES ('".$_GET['id']."','".$data[$id]["nickname"]."','".json_encode(array("players" => array_merge($final, $notFound)))."','".date("Y-m-d H:i:s")."')";
