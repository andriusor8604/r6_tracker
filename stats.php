...
$mmr_gain = 0;
			...
			$sql = "SELECT last_update, user_id, user_stats FROM R6_ WHERE user_id='".$_GET['id']."'";
				...
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
						...
						if(strtotime($nauja_data) > strtotime('-30days'))
						{
						/// MMR LENTELE
							...
							///$sql99 = "INSERT INTO R6_INDEX (mmr_gain, games_played,games_won, games_lost, kd, username, user_id, date) VALUES ('".$mmr_gain."', '".$matchai_nauji."', '".$nauji_winai."', '".$nauji_losai."', '".$naujas_kd."', '".$nickname."', '".$profile_id."', '".$nauja_data."')";
...
///echo $dataPoints;
///$sql99 = "INSERT INTO R6_INDEX (mmr_gain, games_played,games_won, games_lost, kd, username, user_id, date) VALUES ('"$mmr_gain"', '"$matchai_nauji"', '"$nauji_winai"', '"$nauji_losai"', '"$kd"', '"$nickname"', '"$profile_id"', '"$nauja_data"')";
///mysqli_query($con, $sql99);	
$con->close();
